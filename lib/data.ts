...
export const PRODUCTS: Product[] = [
  {
    ...
    images: [
      `${CDN}/l1-max-page-mobile.jpg?v=1765511227`,             // city lifestyle
      `${CDN}/k20_pro_listing_800_1000_m.jpg?v=1774004078`,     // 2nd lifestyle
    ],
  ...
  },
  {
    ...
    images: [
      `${CDN}/800_1200-wuzi.jpg?v=1772768149`,                  // sea road lifestyle
  ...
  },
  {
    ...
    images: [
      `${CDN}/Gosoul_2_pro1800X1000_ad23b595-61fb-4c72-88cf-ec2be4688b74.jpg?v=1774003576`, // rider rocks
  ...
  },
  {
    ...
    images: [
      `${CDN}/DT2_Pro.jpg?v=1767606498`,                        // rider offroad
      `${CDN}/dt2-pro-detail-page-mobile.jpg?v=1765510548`,     // product
    ],
