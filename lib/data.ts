...
export const PRODUCTS: Product[] = [
  {
    ...
    images: [
      `${CDN}/l1-max-page-mobile.jpg?v=1765511227`,   // [0] product on light bg (default)
      `${CDN}/k20_pro_listing_800_1000_m.jpg?v=1774004078`, // [1] lifestyle (hover)
    ],
  ...
  },
  {
    ...
    images: [
      `${CDN}/800x1000_0936ab86-a006-46f0-b540-fddd9d2028dc.jpg?v=1772504724`, // product
      `${CDN}/800_1200-wuzi.jpg?v=1772768149`,  // lifestyle
    ],
    in_stock: true, is_new: false, is_featured: true, tag: null, created_at: '2026-01-01',
  },
  {
    ...
    images: [
      `${CDN}/l2-max-dual-detail-page-mobile.jpg?v=1765511614`, // product
      `${CDN}/Gosoul_2_pro1800X1000_ad23b595-61fb-4c72-88cf-ec2be4688b74.jpg?v=1774003576`, // lifestyle
    ],
  ...
  },
  {
    ...
    images: [
      `${CDN}/dt2-pro-detail-page-mobile.jpg?v=1765510548`, // product on light bg
      `${CDN}/DT2_Pro.jpg?v=1767606498`,                    // action/lifestyle
    ],
...
export function getFeaturedProducts() { return PRODUCTS.filter(p => p.is_featured) }
