...
export default function TermsPage() {
  const sections = [
    { t:'1. Загальні умови', p:'Використовуючи сайт ausom.in.ua, ви погоджуєтесь з цими умовами. Сайт належить Ausom Ukraine — офіційному дистриб\'ютору Ausom в Україні.' },
    ...
    { t:'9. Контакти', p:'support@ausom.in.ua • +38 (067) 000-00-00' },
  ]
