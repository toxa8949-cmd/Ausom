    ...
    <div style={{ minHeight:'100vh', background:'var(--bg)' }}>
      ...
      <div style={{ padding:'48px 0 72px' }}>
        <div className="w-container" style={{ maxWidth:800 }}>
          ...
          <p style={{ fontSize:15, color:'var(--text-2)', marginBottom:36 }}>Повернення та обмін товару згідно Закону України «Про захист прав споживачів».</p>

          <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
            {[
              { icon:'↩️', title:'Повернення товару належної якості', text:'Згідно Закону України «Про захист прав споживачів», ви маєте право повернути товар належної якості, якщо він не був у використанні, збережено товарний вигляд, споживчі властивості, пломби та ярлики.', list:['Товар не був у використанні','Збережено оригінальну упаковку','Наявність чеку або підтвердження покупки','Збережено товарний вигляд'] },
              { icon:'🔄', title:'Обмін товару', text:'Якщо вам не підійшла модель — допоможемо обміняти на іншу. Різницю в ціні можна доплатити або отримати повернення.' },
          ...
          <div style={{ background:'var(--bg-soft)', border:'1.5px solid var(--border)', borderRadius:12, padding:'28px', marginTop:20 }}>
            ...
            <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:16 }}>
              {[
                ...
                { n:'2', t:'Отримайте інструкції', d:'Ми надішлемо ТТН для та інструкції щодо повернення' },
