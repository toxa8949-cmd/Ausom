...
// Each product entry now exposes its image URLs via the standard
// MetadataRoute "images" field, which Next.js renders as <image:image>
// blocks (Google Image sitemap extension). This boosts the chance of
// Google showing a thumbnail next to the product in search results.
