...
const faqData = [
  { title:'Замовлення та доставка', questions:[
    { q:'Як швидко доставляють замовлення?', a:'Нова Пошта — 1-3 робочих дні по всій Україні. Самовивіз з магазину-партнера у Києві — у день замовлення. Замовлення обробляються протягом 1 робочого дня.' },
    { q:'Як здійснюється доставка?', a:'Доставка здійснюється Новою Поштою за тарифами перевізника по всій Україні. Також доступний самовивіз з нашого магазина-партнера «Велокрай» (вул. Ревуцького 40В, Київ).' },
  ...
  { title:'Повернення та гарантія', questions:[
    ...
    { q:'Чи можу я повернути самокат?', a:'Так, згідно Закону України «Про захист прав споживачів». Товар має бути в оригінальній упаковці, без слідів використання, зі збереженим товарним виглядом.' },
    { q:'Що робити, якщо самокат зламався?', a:'Зв\'яжіться з підтримкою: support@ausom.ua або +38 (095) 898-10-07. Діагностика та ремонт по гарантії безкоштовні.' },
  ]},
