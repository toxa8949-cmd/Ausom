...
const BRAND_CONFIG: Record<string, BrandCfgItem> = {
  ausom: {
    ...
    description:
      'Купити електросамокат Ausom в Україні. Ausom L1, L2, L2 Max, DT2 Pro, L2 Dual, L2 Max Dual. Офіційна гарантія 2 роки, доставка Новою Поштою. Ausom київ — доставляємо по всій Україні.',
    keywords: [
    ...
    intro:
      ...
      'Всі моделі Ausom сертифіковані в Україні, мають офіційну гарантію 2 роки та поставляються з доставкою Новою Поштою за тарифами перевізника.',
  },
  kukirin: {
    name: 'Kukirin',
    nameUA: 'Kukirin',
