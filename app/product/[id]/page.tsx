...
export default function ProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'var(--bg)' }}>
        ...
        <div className="w-container">
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:56, alignItems:'start' }}>
            ...
            <div>
              ...
              <h1 style={{ fontSize:'clamp(32px,4vw,48px)', fontWeight:800, letterSpacing:'-.03em', color:'var(--text)', lineHeight:1.05, marginBottom:12 }}>{product.name}</h1>
              ...
              <div style={{ background:'var(--bg-soft)', border:'1.5px solid var(--border)', borderRadius:'var(--radius-lg)', padding:28, marginBottom:16 }}>
                ...
                <div style={{ display:'flex', gap:20, marginTop:16, fontSize:13, color:'var(--text-3)' }}>
      ...
      <div style={{ background:'var(--bg-soft)', borderTop:'1px solid var(--border)', padding:'48px 0 64px' }}>
        <div className="w-container">
      ...
      <div style={{ padding:'56px 0 72px', borderTop:'1px solid var(--border)' }}>
        <div className="w-container">
          <h2 style={{ fontSize:'clamp(24px,3vw,36px)', fontWeight:800, letterSpacing:'-.025em', color:'var(--text)', marginBottom:28 }}>Інші моделі</h2>
              ...
              <Link key={p.slug} href={`/product/${p.slug}`} style={{ textDecoration:'none' }}>
                <div className="card" style={{ overflow:'hidden' }}>
                  ...
                  <div style={{ padding:'20px 18px' }}>
                    ...
                    <div style={{ display:'flex', gap:8, fontSize:12, color:'var(--text-3)', marginBottom:12 }}><span>{p.max_speed} км/г</span><span>•</span><span>{p.range_km} км</span><span>•</span><span>{p.battery_wh} Wh</span></div>
